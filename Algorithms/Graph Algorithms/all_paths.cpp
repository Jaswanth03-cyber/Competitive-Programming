...
*/
/*
Here graph[i-1] is giving the vertices that are adjacent to the node i note here everything is from 0 to n-1.
look for k shortest paths and longest path from src to destination in cses
*/
class Solution {
public:
